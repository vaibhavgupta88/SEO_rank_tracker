...
export const analyzeUrl = async (req, res) => {
    try {
        ...
        try {
            ...
            // Step 3: Save results (Fixed property names to match schema)
            ...
            analysis.headings = scrapeResult.data.headings || {}; // Fixed: heading -> headings
            ...
            try {
                ...
                console.error("Failed to save failed status:", saveError.message); // Fixed typo & scoping
            }
        }
    } catch (error) {
...
// Delete analysis (Fixed findByIdAndDelete to findOneAndDelete)
