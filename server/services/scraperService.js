...
export async function scrapeUrl(url) {
    ...
    try {
        ...
        page.setDefaultNavigationTimeout(30000); // 30s default timeout for navigation
        ...
        const scrapedData = await page.evaluate(() => {
            ...
            const ogTitle = getMeta("og:title"); // Fixed: og:Title -> og:title
            ...
            // Fixed: e1 -> el parameter matching
        ...
        // Fixed: Always return a failed result object to avoid controller crashes
        return {
            success: false,
            error: error.message
        };
